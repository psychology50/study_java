...
public class Practice_ClassMethod {
	
	public static void main(String[] args) {
		
		// 클래스 변수의 가장 큰 특징 2가지
		// 1. 객체를 생성하기 전에 사용 가능
		// 2. 한 번에 모든 인스턴수 변수의 값을 수정할 수 있음.
		
		System.out.println(Member.centerName);
//		System.out.println(Member.name);  // 에러
